...
function App() {
  ...
  let handleClick = (val) => {
    setCalc(prevCalc => prevCalc.toString() + val);
  }
  ...
  return (
    <div className='bg-blue-400  w-full h-screen flex items-center justify-center flex-col'>
      <div className='w-[300px] bg-gray-900 min-h-[500px] shadow-2xl shadow-gray-900 rounded-2xl p-4 flex items-center flex-col'>
        <div>
          <input type="text" value={calc} readOnly className='w-[95%] h-[80px] mt-2 bg-gray-900 outline-none rounded-2xl text-blue-100 text-right text-5xl' />
        </div>
        <div className='flex items-center justify-center gap-3 flex-col m-4'>
          ...
          <div className='flex items-center justify-center gap-3 flex-wrap mt-4'>
            ...
            <div className='h-[55px] w-[250px] flex items-center justify-between gap-3'>
              <div className='bg-[#616161] text-[#A5A5A5] rounded-2xl w-full h-full flex items-center justify-center font-medium cursor-pointer' onClick={() => setCalc("")}>Ac</div>
              <div className='bg-[#616161] text-[#A5A5A5] rounded-2xl w-full h-full flex items-center justify-center font-medium cursor-pointer text-xl' onClick={() => setCalc(calc.slice(0,-1))}><i className="ri-delete-back-2-line font-medium text-md"></i></div>
            ...
            <div className='h-[55px] w-[250px] flex items-center gap-3'>
              ...
              <div className='bg-[#005DB2] text-[#A5A5A5] rounded-2xl h-full flex items-center justify-center font-medium w-[54px] h-[121px] mb-[60px] cursor-pointer' onClick={calculateValues}>=</div>
            </div>
          </div>
