...
export default function App() {
  ...
  let getFollowers = async (data) => {
    let resForFollowers = await fetch(data.followers_url);
    let dataForFollowers = await resForFollowers.json();
    setFollowers(dataForFollowers);
  };
      ...
      {userDetails ? (
        <div>
          ...
          <div className="user-info card">
            <img id="avatar-desktop" />
            <div className="info">
              <div className="general">
                <img src={userDetails.avatar_url} id="avatar-mobile" />
                <div className="personal">
                  <div className="name-info">
                    <h2 id="name">{userDetails.name}</h2>
                    <h3 id="login">{userDetails.login}</h3>
                  </div>
                  <p id="join-date">{userDetails.created_at}</p>
                </div>
              </div>
              ...
              <div className="locations">
                <div className="location-info">
                  ...
                  <h3 className="location-text" id="city">
                    {userDetails.location ? userDetails.location : "Not Added"}
                  </h3>
                </div>
                <div className="location-info">
                  <svg
                  ...
                  >
                    {" "}
                    {userDetails.blog ? userDetails.login : "Not Added"}
                  </a>
                </div>
                <div className="location-info">
                  <svg
                  ...
                  <a
                    id="twitterLink"
                    href={"https://www.x.com/" + userDetails.twitter_username}
                  >
                    <h3 className="location-text" id="twitter">
                ...
                <div className="location-info">
                  ...
                  <h3 className="location-text" id="company">
                    {userDetails.company ? userDetails.company : "Not Added"}
                  </h3>
                </div>
              </div>
            </div>
          ...
          <div className="user-info card">
            ...
            <div className="info">
              ...
              <div className="stats">
                <div className="stat">
                  <h3 className="stat-title">repos</h3>
                  <h3 className="amount" id="repos"></h3>
                </div>
                <div className="stat">
                  <h3 className="stat-title">followers</h3>
                  <h3 className="amount" id="followers"></h3>
                </div>
                <div className="stat">
                  <h3 className="stat-title">following</h3>
                  <h3 className="amount" id="following"></h3>
                </div>
              </div>
              <div className="locations">
                <div className="location-info">
                  ...
                  <h3 className="location-text" id="city"></h3>
                </div>
                <div className="location-info">
                  <svg
                    height="20"
                ...
                <div className="location-info">
                  ...
                  <a id="twitterLink" href="">
                    <h3 className="location-text" id="twitter"></h3>
                  </a>
                </div>
                <div className="location-info">
                  <svg
                  ...
                  <h3 className="location-text" id="company"></h3>
                </div>
              </div>
            </div>
          </div>
