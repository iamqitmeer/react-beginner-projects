...
function Summary({ totalExpense, averageExpense, expenseCount }) {
  return (
    <div className="w-[50%] h-full p-12 flex flex-col gap-4 mt-12">
      ...
      <div className="w-full rounded-xl p-4 bg-gray-200 flex items-center justify-between ">
        ...
        <h1 className="text-xl font-bold">${averageExpense}</h1>
      </div>

      <div className="w-full rounded-xl p-4 bg-gray-200 flex items-center justify-between ">
        <div>
          <h1 className="text-lg font-semibold">Number of Expenses</h1>
        </div>
        <h1 className="text-xl font-bold">{expenseCount}</h1>
      </div>
    </div>
  );
}
